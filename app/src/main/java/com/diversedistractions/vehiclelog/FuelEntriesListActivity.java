...
/*
 * FuelEntriesListActivity displays the existing selected vehicle's fuel entries in a list.
 * 
...
public class FuelEntriesListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				mActionMode = FuelEntriesListActivity.this.startActionMode(mActionModeCallback);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	inflater.inflate(R.menu.fuel_entries_list_menu, menu);
    	return true;
    }
    ...
    private ActionMode.Callback mActionModeCallback = new ActionMode.Callback() {
    	...
    	public boolean onCreateActionMode(ActionMode mode, Menu menu) {
    		...
    		inflater.inflate(R.menu.fuel_entries_list_content_menu, menu);
			return true;
		}
    	...
    	public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
    		...
    		case R.id.delete_entry:
    			...
    			mDbAdapter.deleteFuelEntry(ItemId);
    			fillData();
    			mode.finish();		// Closes the content action bar
    			return true;
   ...
   // Create a new fuel entry for the current vehicle
   private void createEntry() {
	   Intent i = new Intent(this, FuelEntryCreateEditActivity.class);
   ...
   // Edit the selected fuel entry for the current vehicle
   private void editEntry(long id) {
	   Intent i = new Intent(this, FuelEntryCreateEditActivity.class);
	   	  i.putExtra(NEW_ENTRY, 0);
          i.putExtra(DbFuelEntryTable.COL_FUEL_ENTRY_ROW_ID, id);
          i.putExtra(VEHICLE_NAME, mCompVehLabel);
          i.putExtra(VEHICLE_ROW_ID, mVehRowId);
    ...
    private void fillData() {
    	...
    	Cursor dataCursor = mDbAdapter.fetchRelevantFuelEntries(mVehRowId);
    	startManagingCursor(dataCursor);
    	
        // Use the custom cursor adapter to display the data
        setListAdapter(new FuelEntriesListCursorAdapter(this, dataCursor));
    }
